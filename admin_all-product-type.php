			...
			<div class="content container-fluid">
				<div class="page-header">
					<div class="row">
						<div class="col">
							<div class="mt-5">
								<h3 class="card-title float-left">All Product Type</h4> <a href="admin_add-product-type.php" class="btn btn-primary float-right veiwbutton">Add Product Type</a>
							</div>
						</div>
					</div>
				</div>
				<div>
					<table id="product_type_table" class="table table-striped table-bordered table-hover">
						...
						<tbody>
							...
							?>
								<script>
									window.location.href="admin_all-product-type.php";
								</script>
							<?php
								}
							?>
