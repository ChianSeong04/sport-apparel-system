			...
			<div class="content container-fluid">
				<div class="page-header">
					<div class="row">
						<div class="col">
							<div class="mt-5">
								<h3 class="card-title float-left">All Product Brand</h3> <a href="admin_add-product-brand.php" class="btn btn-primary float-right veiwbutton">Add Product Brand</a> 
							</div>
						</div>
					</div>
				</div>
				<div>
					<table id="product_brand_table" class="table table-striped table-bordered table-hover">
						<thead>
						...
						<tbody>
							...
							?>
								<script>
									window.location.href="admin_all-product-brand.php";
								</script>
							<?php
