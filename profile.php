...
<!--start-ckeckout-->
	<div class="ckeckout">
		<div class="container">
			<div class="ckeckout-top">
				<iframe src="iframe_profile.php" style="position:absolute;top:150px; left:30;right:90; bottom:100;width:1500px;height:470px;border:none; margin:0; padding:0;z-index:1" id="my-iframe""></iframe>
	...
	<!-- Start Footer -->
    <footer class="bg-dark" id="tempaltemo_footer" style="z-index:-3;">
        <div class="container">
            <div class="row">
