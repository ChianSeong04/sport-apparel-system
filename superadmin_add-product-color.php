						...
						<form method="post" autocomplete="off">
							...
							<div class="col-md-4">
									<div class="form-group">
										...
										<input class="form-control" type="text" placeholder="Enter product color" name="product_color" oninput="this.value=this.value.replace(/[^A-z]/g,'');" required> <span id="error" style="color:red;"><?php echo $error; ?></span></div>
